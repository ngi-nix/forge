...

{
  ...
  apps.scion = {
    ...
    usage = ''
       A sample [local topology environment](https://docs.scion.org/en/v0.15.1/dev/run.html#running-scion-locally)
       is provided, based on the
       [Quickstart](https://docs.scion.org/en/v0.15.1/dev/run.html#quickstart)
       ...
       ```bash
       scion-topology-tiny4-init # prepare all required files in the current directory
       ```
